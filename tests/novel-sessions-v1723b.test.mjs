...
assert.match(index, /unlimited-novel-revision" content="2026-08-23-v17\.23b-novel-session-management"/);
...
assert.match(readme, /V17\.23C — 作品 \/ 章节 \/ 创作资料导航 ⏳ 下一阶段/);
assert.match(readme, /V17\.23D — 输入区、顶部栏和最终 UX 收口 ⏳ 待完成/);

console.log("V17.23B novel session management contract passed.");
