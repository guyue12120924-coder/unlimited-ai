...
// V17.23D final UX is loaded from the stable novel V17.23A entry so it stays
// independent from the companion production chain and old app/studio cores.
...
assert.match(readme, /收藏按钮旁直接增加“删除”按钮/);
