...
assert.match(index, /companion-atmosphere-v1715\.css\?v=20260823-v17\.15-adaptive-atmosphere/);
...
console.log('V17.15 adaptive companion atmosphere contract passed');